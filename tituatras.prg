/*
    ...
    Programa.....: tituatras.prg
    Finalidade...: Consulta de faturas
                   CONSULTA DE FATURAS EM ATRASO
    Autor........: Sergio Lima
...
PROCEDURE TITUATRAS()
    ...
    LOCAL lSair := .F.
    LOCAL hAtributos := { ;
        "TITULO" => "CONSULTA DE FATURAS EM ATRASO", ;
    ...
    nQtdRegistros := QUERY_COUNTER(hStatusBancoDados["pBancoDeDados"], SQL_CONSULTA_TITUATRAS_COUNT)

    pRegistros := QUERY(hStatusBancoDados["pBancoDeDados"], SQL_CONSULTA_TITUATRAS)
